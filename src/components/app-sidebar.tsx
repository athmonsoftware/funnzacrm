      ...
      <SidebarHeader className="px-4 pt-5 pb-4">
        <Link href="/dashboard" className="flex items-center gap-3 group">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[11px] text-funza-text-muted">
              {organizationName}
            </span>
          </div>
        </Link>
                    ...
                    >
                      <Icon
                        ...
                        className={
                          isExactActive
                            ? "text-white"
                            : "text-funza-text-muted group-hover/item:text-funza-text-secondary"
                        }
                      />
                        ...
                        <span
                          className={`ml-auto flex h-5 min-w-5 items-center justify-center rounded-full px-1.5 text-[10px] font-bold ${
                            isExactActive
                              ...
                              : "bg-funza-primary/10 text-funza-primary"
                          }`}
                        >
                          {item.badge}
                        </span>
                        ...
                        <ChevronRight
                          ...
                          className={`ml-auto transition-opacity ${
                            isExactActive
                              ...
                              : "opacity-0 group-hover/item:opacity-100 text-funza-text-muted"
                          }`}
                        />
                      )}
                    </SidebarMenuButton>
