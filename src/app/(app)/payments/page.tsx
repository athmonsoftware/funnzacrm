          ...
          <section className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
                Monitor successful, pending, and failed payments across mobile
                money, bank transfer, and subscriptions.
              </p>
            </div>
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-5">
          ...
          <Card>
            <div className="flex flex-col items-center justify-center p-12 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                When you start processing payments, they will appear here.
              </p>
            </div>
          </Card>
        </div>
...
function Summary({
  ...
  return (
    <Card className="p-4">
      <span
        className={`flex h-10 w-10 items-center justify-center rounded-md ${color}`}
      >
        <Icon size={18} />
      </span>
